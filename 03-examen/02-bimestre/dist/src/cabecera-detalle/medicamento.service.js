...
let MedicamentoService = class MedicamentoService {
    ...
    insertarCliente(medicamento) {
        const objetoEntidad = this._medicamentoRepository
            .create(medicamento);
        return this._medicamentoRepository.save(objetoEntidad);
    }
    obtenerMedicamentos(parametrosBusqueda) {
        return this._medicamentoRepository.find(parametrosBusqueda);
    }
    actualizarCliente(medicamento) {
    }
    borrarCliente(medicamento) {
    }
};
MedicamentoService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(medicamento_entity_1.CabeceraEntity)),
